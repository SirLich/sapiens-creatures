...
table.insert(mainThreadAnimationGroup.animations, animationTypes.idle, mainThreadAnimationGroup.animations[animationTypes.idleAngry])
table.insert(mainThreadAnimationGroup.animations, animationTypes.run, mainThreadAnimationGroup.animations[animationTypes.walk])
